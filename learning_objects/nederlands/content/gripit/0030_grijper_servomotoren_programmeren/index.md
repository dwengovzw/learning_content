    ...
    <div class="items">
        <div class="info_item item">
            ...
            <p class="info_item_content">
                Elke 'Grip->IT'-grijper gebruikt een of meer servomotoren. Halberd heeft vier aansluitingen voor servo's. Elke servo-aansluiting heeft drie pinnen: GND, 5V en PWM. Sluit de stekker van een servomotor aan door de draden te laten overeenkomen met de gekleurde stippen bij de pinlabels op de Halberd.
            </p>
            <p class="info_item_content">
