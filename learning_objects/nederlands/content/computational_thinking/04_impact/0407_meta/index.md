...
<ul>
    ...
    <li>Hoe stel je een beslissingsboom op?
        <ul>
            ...
            <li>Hoe geef je een ja-neevraag vorm met logische (wiskundige) uitdrukking? </li>
...
<ul>
    <li>De reallife voorbeelden tonen dat zulke data vaak worden voorgesteld door een gerichte gewortelde graaf, meestal binair. M.a.w. een binaire beslissingsboom is geschikt om data te representeren.</li>
...
<ul>
    ...
    <li>De beslissingsboom is een abstracte voorstelling van de oplossing in de vorm van een graaf. Het is een model voor de oplossing
    <li>Deze voorstelling is bovendien transparant.
    <li>Abstractie komt ook voor:
        <ul>
            <li>als je da mate van spreiding weergeeft door een getal; en
