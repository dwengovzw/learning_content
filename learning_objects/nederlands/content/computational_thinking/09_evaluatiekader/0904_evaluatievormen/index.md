...
## Veelvoorkomende evaluatievormen

**Schriftelijke opdracht - gesloten vragen**<br>
Bij een opdracht met gesloten vragen evalueert de leerkracht een schriftelijke prestatie waarbij de leerling een antwoord selecteert uit een vooraf opgestelde set van mogelijke antwoorden. Voorbeelden van gesloten vragen zijn meerkeuzevragen, 'waar/onwaar'-vragen, matching-vragen, volgordevragen ...
...
> Aandachtspunt: Niet alle aspecten van computationeel denken kunnen echter met meerkeuzevragen beoordeeld worden (Roman-Gonzalez et al., 2019; Weintrop et al., 2021).
...
Pen-en-papier kan ook zinvol zijn in het kader van het creëren van een artefact, bv. om te laten neerschrijven welke representaties ze zullen gebruiken, om een algorime in pseudocode te ontwerpen, of om een ontwerp van een oplossing te tekenen (Weintrop et al., 2021).
...
**Interview**<br>
Tijdens een interview stelt de leerkracht gericht vragen aan de leerling om dieper inzicht te krijgen in de kennis, vaardigheden, denkwijze en mogelijks ook in de gevoelens of motivaties van de leerling. Het helpt de leerkracht om de leerling beter te kunnen doorgronden.
...
<strong><h5>Wat zou je kunnen beoordelen?</h5></strong>
<ul>
    <li>Beoordeel in welke mate het werkstuk de beoogde doelstelling bereikt.</li>
    <li>Beoordeel in welke mate het werkstuk voldoet aan de vereisten die in de opdracht zijn gegeven.</li>
    <li>Beoordeel in welke mate het werkstuk inhoudelijke diepgang heeft.</li>
    <li>Beoordeel in welke mate het werkstuk presentabel (zoals lay-out, leesbaarheid, overzichtelijke opbouw ...) is.</li>
    <li>Beoordeel in welke mate het werkstuk creatief (extra, interessante elementen) en/of origineel (unieke, persoonlijke elementen) is.</li>
    <li>...</li>
</ul>
</div>
...
Observaties in informaticaonderwijs kunnen waardevol zijn omdat veel aspecten van de informatica abstract of complex zijn, zoals digitaal inzicht, computationeel denken, creativiteit, doorzettingsvermogen ...

Voordat je begint met observeren, bepaal je welke specifieke aspecten van een prestatie, vaardigheid en/of het gedrag van de leerlingen je wilt evalueren.

**Prestatieobservatie**<br>
Observeer leerlingen om hun prestaties te beoordelen.

Voorbeeld: je kan leerlingen observeren terwijl ze een algoritme opstellen om te beoordelen in welke mate ze de opdracht begrijpen, in welke mate ze in staat zijn om hun gedachten en ideeën te formuleren en te ordenen.

**Vaardigheidsobservatie**<br>
Observeer leerlingen om hun vaardigheden (digitale zelfredzaamheid) te beoordelen.

Voorbeeld: je kan leerlingen observeren terwijl ze een digitale opdracht uitvoeren om te beoordelen in welke mate ze vaardig zijn in het gebruik van digitale infrastructuur, digitale tools, digitale bestanden ...

**Gedragsobservatie**<br>
Observeer leerlingen om hun houding en gedrag te beoordelen.

Voorbeeld: je kan leerlingen observeren tijdens een groepswerk om te beoordelen in welke mate leerlingen samenwerken, of ze respectvol met elkaar omgaan, of ze actief bijdragen aan de groep, of ze goed luisteren naar de ideeën van anderen ...

**Maak gebruik van een observatiewijzer**<br>
Om een ​​overzicht te hebben van wat je observeert, kan het nuttig zijn om een ​​observatiewijzer te maken. Dit kan een tabel zijn met de aspecten die je wilt evalueren met een kolom voor elk van de leerlingen. Hiermee kun je tijdens de les of activiteit snel notities maken over de observaties. Het is belangrijk om de observaties op een systematische manier vast te leggen, want dit helpt om de informatie gestructureerd te verzamelen en later te gebruiken bij het geven van feedback en het eventueel aanpassen van de lesaanpak.

<div class="alert alert-box alert-secondary">
<strong><h5>Voorbeeld observatiewijzer voor programmeervaardigheden</h5></strong>
<ul>
    <li>Probleemdefinitie
        <ul>
            <li>Begrijpt de opdracht en het probleem</li>
            <li>Deelt het probleem in stappen op</li>
        </ul>
    </li>
    <li>Patroomherkenning en abstractie
        <ul>
            <li>Herkent patronen</li>
            <li>Begrijpt en gebruikt functies</li>
        </ul>    
    </li>   
    <li>Algoritmen
        <ul>
            <li>Heeft een geschikte aanpak gekozen</li>
            <li>Begrijpt en gebruikt de juiste programmeerconcepten</li>
        </ul>    
    </li>
    <li>Code
        <ul>
            <li>Vertaalt het algoritme in correcte code</li>
            <li>Gebruikt correcte syntax</li>
            <li>Is gemakkelijk leesbaar</li>
        </ul>
    </li>
        <ul>
            <li>Testen
            <li>Heeft de oplossing meermaals getest</li>
            <li>Heeft rekening gehouden met speciale gevallen</li>
        </ul>
    </li>
</ul>
</div>
...
**Tips**
* Zoek tijdens de observatie naar successen.
* Zoek tijdens de observatie naar fouten.
* Controleer wie veel vragen heeft en wat de aard van de vragen zijn.
...
Voordat je begint met interviewen, bepaal je welke specifieke aspecten van competenties van de leerling je wilt evalueren.

**Kennis**<br>
Stel aan de leerling gerichte vragen om de kennis over een bepaald onderwerp te beoordelen.
Bijvoorbeeld vragen over feiten, concepten, principes, procedures ...

**Vaardigheden**<br>
Stel aan de leerling gerichte vragen om de vaardigheden om een taak uit te voeren of een probleem op te lossen te beoordelen.
Bijvoorbeeld vragen over de stappen die ze zetten om een bepaalde taak uit te voeren.

**Attitudes**<br>
Stel aan de leerling gerichte vragen om het gedrag en de houding te beoordelen.
Bijvoorbeeld vragen over hoe ze staan ten opzichte van samenwerking, verantwoordelijkheid, respect ...

Interviews kunnen ook worden ingezet om het **reflectief vermogen** van de leerling te evalueren.
Bijvoorbeeld door te vragen naar het eigen leerproces, hoe hij/zij omgaat met feedback, wat hij/zij heeft geleerd uit fouten ...

**Maak gebruik van een vragenlijst**<br>
Op basis van het doel van het interview maak je een lijst met gerichte vragen. Probeer zo veel als mogelijk open vragen te stellen die de leerling aanmoedigen om uitgebreid te antwoorden.

<div class="alert alert-box alert-secondary">
<strong><h5>Voorbeeld vragenlijst met betrekking tot decompositie</h5></strong>
<ul>
    <li>Welke stappen volg je normaal gesproken wanneer je een nieuw probleem moet oplossen?</li>
    <li>Kun je een voorbeeld geven van een probleem dat je onlangs hebt opgelost en hoe je dit hebt opgesplitst in kleinere deelproblemen?</li>
    <li>Wat is volgens jou het voordeel van het opdelen van een probleem in kleinere deelproblemen?</li>
    <li>Hoe bepaal je welke deelproblemen het belangrijkst zijn om als eerste op te lossen?</li>
    <li>Hoe bepaal je wanneer je een deelprobleem hebt opgelost en verder kunt gaan naar het volgende deelprobleem?</li>
</ul>
</div>

**Tips**
* Kies een locatie waar je ongestoord het interview kan afnemen.<br>Zorg ook dat je voldoende tijd hebt om de leerling alle vragen te stellen en dat je niet gehaast bent.
* Leg aan de leerling uit waarom je het interview afneemt en wat je wilt evalueren.<br>Zorg dat de leerling weet dat het gaat om het herkennen van wat hij/zij goed doet en wat hij/zij kan verbeteren. 
* Stel de vragen op je lijst op een natuurlijke en vriendelijke manier.<br>Moedig de leerling aan om uitgebreid te antwoorden en eventuele onduidelijkheden uit te leggen.
* Luister aandachtig naar de antwoorden van de leerling en noteer belangrijke punten of opmerkingen.<br>Dit zal je helpen bij het maken van je evaluatie.
* Na het interview kan je kort terugkoppelen naar de leerling over hoe het interview verliep en wat je hebt waargenomen.<br>Dit kunnen bijvoorbeeld de sterke punten of ontwikkelpunten van de leerling zijn.
* Verwerk de informatie die je hebt verzameld tijdens het interview in je evaluatie.<br>Maak aantekeningen van belangrijke punten en koppel deze terug aan de leerling of andere belanghebbenden, indien nodig.

## Portfolio in informaticaonderwijs

Een portfolio is in informaticaonderwijs een **dynamische tool**, die de leerlingen de mogelijkheid biedt om hun technische vaardigheden, praktische toepassingen, soft skills ..., en **persoonlijke groei** op een georganiseerde manier te presenteren. Het laat leerlingen ook toe om dat waar ze zeer goed in zijn, in de verf te zetten.<br>
De verwachte inhoud van het protfolio wordt op voorhand vastgelegd.

De inhoud van het portfolio wordt bepaald door het doel van het portfolio. Grofweg zijn er een drietal types te onderscheiden.

**Showcase portfolio**<br>
* Maakt het beste werk van de leerling zichtbaar.
* Bij dit portfolio ligt de focus op het verzamelen van ontwerpen/realisaties om deze te presenteren en/of te gebruiken ter staving van een mondelinge verdediging. De inhoud van het portfolio bevat producten, die door leerling zijn geselecteerd.

**Assessment portfolio**<br>
* Maakt zichtbaar wat de leerling heeft geleerd.
* Bij dit portfolio ligt de focus op het verzamelen van de gemaakte opdrachten/taken om in kaart te brengen in welke mate de leerling de onderwijsdoelen heeft bereikt. De inhoud van dit portfolio wordt vastgelegd door de leraar.

**Learning portfolio**<br>
* Maakt zichtbaar hoe de leerling aan het leren is.
* Bij dit portfolio ligt de focus op het verzamelen van materialen met betrekking tot het leerproces zoals verslagen, opdrachten, ontwerpen, reflecties ..., om vervolgens met de leerling in gesprek te gaan en gepaste feedback te geven. De inhoud van het portfolio bevat werk in uitvoering en het eigenaarschap ligt bij de leerling zelf.

<div class="alert alert-box alert-success">
<strong><h5>Wat zou je kunnen beoordelen?</h5></strong>
<ul>
    <li>Beoordeel in welke mate de inhoud van het portfolio het doel ondersteunt.</li>
    <li>Beoordeel in welke mate het portfolio de vereiste componenten bevat.</li>
    <li>Beoordeel in welke mate het werk voldoet aan de vereisten die in de opdracht(en) zijn gegeven.</li>
    <li>Beoordeel in welke mate de organisatie van het portfolio logisch is opgebouwd.</li>
    <li>Beoordeel in welke mate het portfolio gebruiksvriendelijk is gepresenteerd.</li>
    <li>...</li>
</ul>
</div>
...
Peerfeedback is in informaticaonderwijs een waardevolle kans om de **ontwikkeling van programmeer-, probleemoplossende, technische en communicatieve vaardigheden** van leerlingen te stimuleren, alsook om hen voor te bereiden op **samenwerken**.

**Tips**
* Geef duidelijke instructies en ondubbelzinnige criteria zodat de leerlingen gerichte feedback kunnen geven en ontvangen.
* Laat leerlingen oefenen met het geven van feedback.
* Laat feedback geven in duo’s of in kleine groepen.
* Gebruik digitale tools (zoals een padlet, cloudomgeving, peer review tools ...) om de communicatie te vergemakkelijken

<div class="alert alert-box alert-secondary">
<strong><h5>Voorbeeld peerfeedbackopdracht bij programmeren</h5></strong>
<ul>
    <li>Context
        <ul>
            <li>Leerlingen hebben de opdracht gekregen om een eenvoudige functie te programmeren die twee getallen optelt en het resultaat teruggeeft.</li>
            <li>Elke leerling deelt de broncode van hun optelfunctie met een medeleerling (peer).</li>
        </ul>
    </li>
    <li>Test uit
        <ul>
            <li>Probeer het programma van je peer uit met verschillende getallen.</li>
            <li>Kies zowel positieve als negatieve waarden en noteer eventuele onnauwkeurigheden of fouten in de berekening.</li>
        </ul>
    </li>
    <li>Code
        <ul>
            <li>Leesbaarheid<br>Is de code gemakkelijk te volgen?<br>Heeft de student variabelen en functies duidelijk benoemd?</li>
            <li>Correctheid<br>Zijn de resultaten van de optelling juist?</li>
            <li>Efficiëntie<br>Zijn er onnodige stappen of herhalingen in de code?</li>
        </ul>
    </li>
    <li>Feedback geven
        <ul>
            <li>Positieve feedback<br>Benoem wat goed en effectief was in de code.<br>Bijvoorbeeld: "Je hebt duidelijke namen voor de variabelen gekozen."</li>
            <li>Constructieve feedback<br>Geef suggesties voor verbetering.<br>Bijvoorbeeld: "Misschien is het goed om te controleren of de ingevoerde waarden echt getallen zijn ."</li>
            <li>Vragen stellen<br>Als een bepaald deel van de code onduidelijk is, vraag dan om uitleg aan je peer.</li>
        </ul>
    </li>
    <li>Feedback ontvangen
        <ul>
            <li>Luister aandachtig en zonder te onderbreken naar je peer.</li>
            <li>Stel vragen ter verduidelijking en noteer belangrijke punten van de feedback.</li>
        </ul>
    </li>
    <li>Reflectie
        <ul>
            <li>Wat heb je van deze feedbackoefening geleerd?</li>
            <li>Welke wijzigingen ga je uitvoeren op basis van de feedback?</li>
        </ul>
    </li>
</ul>
</div>