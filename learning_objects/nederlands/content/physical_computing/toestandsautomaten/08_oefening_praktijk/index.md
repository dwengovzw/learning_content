...
Om af te sluiten, bieden we nog een oefening aan om te oefenen op het omzetten van een gedragsbeschrijving naar effectieve code. De opdracht is dezelfde als hiervoor: schrijf een code (in onze simulator) die het omschreven systeem realiseert. Je kan dit doen met code, of aan de hand van onze grafische methode Blockly.
