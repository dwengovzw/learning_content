...
<br>
*Embeddings* zetten tekst dus om naar vectoren. Bij word2vec zijn **semantisch verwante teksten dicht bij elkaar in de vectorruimte** geplaatst. Bijvoorbeeld, omdat de woorden ‘kat’ en ‘hond’ in teksten vaak samen voorkomen met het woord ‘dierenarts’, kan men in de vectorruimte kan de overeenkomstige drie vectoren dicht bij elkaar vinden. Ook vergelijkbare relaties tussen woorden zijn in de vectorruimte vaak terug te vinden (zie Figuur).
