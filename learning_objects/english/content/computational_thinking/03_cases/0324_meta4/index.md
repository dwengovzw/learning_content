...
Actions that repeat multiple times, and more complex actions, can be encapsulated in a user-defined function. </patternRecognition> <abstraction>
**Abstraction**<br>
An action composed of multiple sub-actions can be abstracted into an (overarching) action.<br>

<ul>
    <li>Angle of a servo motor is **abstracted** to an integer from -180 to 180.</li>
    <li>Speed of a servo motor is **abstracted** to an integer from -255 to 255.</li>
</ul>
</abstraction>
<algorithms>
